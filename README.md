...
| [`dev-ledger`](https://github.com/whaiman/dev-ledger) | DevLedger is a local, append-only coding activity tracking system for VS Code. It records developer events (file focus, edits, saves, and idle states) into a tamper-evident log with cryptographic hash chaining. The data is fully processed locally and can be deterministically converted into statistics and reports for README or external analysis. | `TypeScript` |
...
![whaiman's GitHub stats](https://github-readme-stats.vercel.app/api?username=whaiman&show_icons=true&theme=codeSTACKr)
![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=whaiman&layout=compact&theme=codeSTACKr)
